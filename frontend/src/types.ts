...
export type Application = { id: string; tool: string; risk: Risk; role: Role; actor: string; status: 'pending' | 'approved' | 'rejected'; reason: string; durationHrs: number; createdAt: string; decidedAt?: string; decision?: string };
...
export type ApplicationRequest = { tool: string; risk: Risk; role: Role; reason: string; durationHrs?: number };
