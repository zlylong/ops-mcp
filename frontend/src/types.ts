...
export type AgentAPIKeyStatus = 'active' | 'revoked' | 'expired' | string;
export type AgentAPIKey = { id: string; name: string; actor: string; role: Role; reason?: string; scopes?: string[]; keyPrefix: string; status: AgentAPIKeyStatus; createdAt: string; expiresAt?: string; lastUsedAt?: string; revokedAt?: string };
